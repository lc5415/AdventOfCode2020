...
# ╔═╡ 0f0405e8-3625-11eb-1140-17f8049760c1
md"# Advent of Code 2020 - Day 4"

# ╔═╡ 430021a8-3625-11eb-14d1-b337c09b3c9a
input = 
...
# ╔═╡ 5b00e6b6-3625-11eb-2f89-438427f7c969
splinput = split(input, "\n\n")

# ╔═╡ b3b8e1dc-3625-11eb-0024-6f41e44d5500
split(splinput[1], ['\n', ' '])

# ╔═╡ a0ff7e2e-3626-11eb-0e41-35442c56bd55
length(split(splinput[1], ['\n', ' ']))

# ╔═╡ 430a7e1c-362c-11eb-2fa3-89bb96beae7b
keys = ["byr:",
"iyr:",
"eyr:",
"hgt:",
...
# ╔═╡ 14f5142c-3629-11eb-0861-f7a243930516
md"Read about variable scope in Julia [here](https://docs.julialang.org/en/v1/manual/variables-and-scoping/#Local-Scope)"

# ╔═╡ c730ae2a-362f-11eb-2ab5-3dcebc64474f
md"## Part 2"

# ╔═╡ fee9c76a-3630-11eb-3578-659c94bb3b1d
function qsplit(in_str) 
	a = split(in_str, ':')
	return a[1] => a[2]
end 

# ╔═╡ 40a4ae86-3631-11eb-350c-f100027545d5
md"## ^^ This is really cool"

# ╔═╡ ced346ce-362f-11eb-297c-49534658ff74
dic = Dict(qsplit(to_dic) for to_dic in split(splinput[1], ['\n', ' ']))

# ╔═╡ a729fc4c-3631-11eb-14c8-ab2ce54f2abd
1920 < 1950 < 2020 ## cool syntax

# ╔═╡ f33d9cc4-3631-11eb-2994-f171f64bfc17
occursin(r"de|in", "cmod") ## regex

# ╔═╡ fe0d3334-3632-11eb-146a-33ce12782ab5
split("185cm", "cm")

# ╔═╡ 6ac5e9ce-3635-11eb-364d-9914850a3f4c
split(splinput[285], ['\n', ' '])
